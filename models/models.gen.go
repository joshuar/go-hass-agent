...
type Location struct {
	...
	Altitude int `json:"altitude,omitempty,omitzero"`

	// Battery is the percentage of battery the device has left. Must be greater than 0.
	Battery int `json:"battery,omitempty,omitzero"`
	...
	Course int `json:"course,omitempty,omitzero"`
	...
	Speed int `json:"speed,omitempty,omitzero"`

	// VerticalAccuracy is the accuracy of the altitude value, measured in meters. Must be greater than 0.
	VerticalAccuracy int `json:"vertical_accuracy,omitempty,omitzero"`
}
...
type Sensor struct {
	// Attributes defines additional custom attributes of a entity.
	Attributes Attributes `json:"attributes,omitempty,omitzero"`

	// DeviceClass is a valid Binary Sensor or Sensor device class.
	DeviceClass string `json:"device_class,omitempty,omitzero"`

	// Disabled indicates if the entity should be enabled or disabled.
	Disabled bool `json:"disabled,omitempty,omitzero"`

	// EntityCategory is the entity category of the entity.
	EntityCategory EntityCategory `json:"entity_category,omitempty,omitzero"`

	// Icon is a material design icon to represent the entity. Must be prefixed mdi:. If not provided, default value is mdi:cellphone.
	Icon Icon `json:"icon,omitempty,omitzero"`
	...
	StateClass string `json:"state_class,omitempty,omitzero"`
	...
	UnitOfMeasurement Units `json:"unit_of_measurement,omitempty,omitzero"`
}

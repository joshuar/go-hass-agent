// Code generated by "stringer -type=hsiResult,hsiLevel -output hsi.gen.go -linecomment"; DO NOT EDIT.
...
func (i hsiResult) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_hsiResult_index)-1 {
		return "hsiResult(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _hsiResult_name[_hsiResult_index[idx]:_hsiResult_index[idx+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i hsiLevel) String() string {
	idx := int(i) - 0
	if i < 0 || idx >= len(_hsiLevel_index)-1 {
		return "hsiLevel(" + strconv.FormatInt(int64(i), 10) + ")"
	}
	return _hsiLevel_name[_hsiLevel_index[idx]:_hsiLevel_index[idx+1]]
}

...
// All of the possible GPU vendors, this is used to find the correct way to find these memory statistics. We map these
// to an iota so we can use these values as settings.
const (

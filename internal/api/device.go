...
// apiKey is the key for API values in Contexts. It is unexported; clients
...
func StoreAPIInContext(ctx context.Context, a DeviceAPI) context.Context {
...
func FetchAPIFromContext(ctx context.Context) (DeviceAPI, error) {
	if c, ok := ctx.Value(apiKey).(DeviceAPI); !ok {
...
func GetAPIEndpoint[T any](api DeviceAPI, endpoint string) T {

...
func (mock *PollingTypeMock) Sensors(ctx context.Context) ([]sensor.Details, error) {
...
//			EventsFunc: func(ctx context.Context) (chan sensor.Details, error) {
...
func (mock *EventTypeMock) Events(ctx context.Context) (chan sensor.Details, error) {
...
// Sensors calls SensorsFunc.
func (mock *EventTypeMock) Sensors(ctx context.Context) ([]sensor.Details, error) {
	if mock.SensorsFunc == nil {
...
// Sensors calls SensorsFunc.
func (mock *OneShotTypeMock) Sensors(ctx context.Context) ([]sensor.Details, error) {
	if mock.SensorsFunc == nil {

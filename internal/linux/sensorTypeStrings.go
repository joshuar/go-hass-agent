...
func _() {
	...
	_ = x[SensorLoad5-42]
	_ = x[SensorLoad15-43]
	_ = x[SensorScreenLock-44]
	_ = x[SensorProblem-45]
	_ = x[SensorKernel-46]
	_ = x[SensorDistribution-47]
	_ = x[SensorVersion-48]
	_ = x[SensorUsers-49]
	_ = x[SensorDeviceTemp-50]
	_ = x[SensorPowerState-51]
}
...
var _SensorTypeValue_index = [...]uint16{0, 10, 22, 34, 47, 66, 81, 95, 108, 121, 133, 146, 159, 171, 187, 198, 210, 227, 243, 259, 269, 285, 298, 315, 330, 345, 360, 372, 384, 394, 409, 425, 446, 457, 467, 481, 502, 527, 540, 551, 557, 581, 605, 630, 641, 649, 663, 680, 700, 713, 724, 735}

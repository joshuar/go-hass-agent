...
//			},
//			DisplayRegistrationWindowFunc: func(contextMoqParam context.Context, agent ui.Agent, valCh chan struct{})  {
...
func (mock *AgentUIMock) DisplayRegistrationWindow(contextMoqParam context.Context, agent ui.Agent, valCh chan struct{}) {

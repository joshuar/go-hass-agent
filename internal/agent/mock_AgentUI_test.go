...
//			},
//			DisplayRegistrationWindowFunc: func(contextMoqParam context.Context, valCh chan struct{})  {
//				panic("mock out the DisplayRegistrationWindow method")
//			},
//			DisplayTrayIconFunc: func(contextMoqParam context.Context, agent ui.Agent)  {
...
func (mock *AgentUIMock) DisplayRegistrationWindow(contextMoqParam context.Context, valCh chan struct{}) {
	...
	mock.DisplayRegistrationWindowFunc(contextMoqParam, valCh)
}
...
func (mock *AgentUIMock) DisplayTrayIcon(contextMoqParam context.Context, agent ui.Agent) {
